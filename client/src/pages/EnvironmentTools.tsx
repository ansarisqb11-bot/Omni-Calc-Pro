...
function EarthDistanceCalculator() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="Earth Distance" icon={Globe} iconColor="bg-blue-500">
      ...
      <ToolCard title="Distance" icon={MapPin} iconColor="bg-emerald-500">
...
function MapScaleConverter() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="Map Scale Converter" icon={MapPin} iconColor="bg-amber-500">
        <div className="space-y-4">
            ...
            {["cm", "mm", "inch"].map((u) => (
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm ${
                  unit === u ? "bg-amber-500 text-white" : "bg-muted text-muted-foreground"
                }`}
      ...
      <ToolCard title="Real Distance" icon={Globe} iconColor="bg-emerald-500">
...
function WindChillCalculator() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="Wind Chill Calculator" icon={Wind} iconColor="bg-cyan-500">
        <div className="space-y-4">
          <div className="flex gap-2">
            {(["C", "F"] as const).map((u) => (
              <button
                ...
                className={`flex-1 py-2 rounded-lg text-sm ${
                  tempUnit === u ? "bg-cyan-500 text-white" : "bg-muted text-muted-foreground"
                }`}
      ...
      <ToolCard title="Wind Chill" icon={Thermometer} iconColor="bg-emerald-500">
        <div className="text-center py-6">
...
function HeatIndexCalculator() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="Heat Index Calculator" icon={Thermometer} iconColor="bg-orange-500">
        <div className="space-y-4">
          <div className="flex gap-2">
            {(["C", "F"] as const).map((u) => (
              <button
                ...
                onClick={() => setTempUnit(u)}
                className={`flex-1 py-2 rounded-lg text-sm ${
                  tempUnit === u ? "bg-orange-500 text-white" : "bg-muted text-muted-foreground"
                }`}
                data-testid={`button-temp-${u}`}
              >
                {u === "C" ? "Celsius" : "Fahrenheit"}
      ...
      <ToolCard title="Heat Index" icon={Wind} iconColor="bg-emerald-500">
        <div className="text-center py-6">
...
function CarbonFootprint() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="Carbon Footprint" icon={Leaf} iconColor="bg-green-500">
        <div className="space-y-4">
      ...
      <ToolCard title="Annual CO2 Emissions" icon={Cloud} iconColor="bg-emerald-500">
        <div className="text-center py-4 mb-4">
          <div className="text-4xl font-bold text-green-400 mb-2">{(totalCO2 / 1000).toFixed(2)}</div>
          <p className="text-muted-foreground">Tonnes CO2 per year</p>
        </div>
        <div className="space-y-3">
...
function AQIExplainer() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="AQI Explainer" icon={Cloud} iconColor="bg-sky-500">
        <div className="space-y-4">
          <InputField label="AQI Value" value={aqi} onChange={setAqi} type="number" min={0} max={500} />
        </div>
      </ToolCard>

      <ToolCard title="Air Quality" icon={Wind} iconColor="bg-emerald-500">
        <div className="text-center py-6">
...
function AltitudeOxygen() {
  ...
  return (
    <div className="space-y-4 max-w-lg mx-auto">
      <ToolCard title="Altitude vs Oxygen" icon={Mountain} iconColor="bg-indigo-500">
        <div className="space-y-4">
          <div className="flex gap-2">
            {(["m", "ft"] as const).map((u) => (
              <button
                ...
                onClick={() => setUnit(u)}
                className={`flex-1 py-2 rounded-lg text-sm ${
                  unit === u ? "bg-indigo-500 text-white" : "bg-muted text-muted-foreground"
                }`}
      ...
      <ToolCard title="Oxygen Levels" icon={Cloud} iconColor="bg-emerald-500">
        <div className="space-y-3">
